...
public class VLCPlayerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        try {
            ...
            rlHub = (RelativeLayout) findViewById(R.id.rl_play);
            seekBarTime = (SeekBar) findViewById(R.id.progress_bar);
            ...
            tvCurrentTime = (TextView) findViewById(R.id.tv_curTime);
